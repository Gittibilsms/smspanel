...
namespace GittBilSmsCore.Migrations
{
    ...
    [Migration("20250720205153_RenameDirectoryToPhoneDirectory")]
    partial class RenameDirectoryToPhoneDirectory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GittBilSmsCore.Models.DirectoryNumber", b =>
                {
                    ...
                    b.Property<int?>("PhoneDirectoryDirectoryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PhoneDirectoryDirectoryId");
            ...
            modelBuilder.Entity("GittBilSmsCore.Models.DirectoryNumber", b =>
                {
                    b.HasOne("GittBilSmsCore.Models.PhoneDirectory", null)
                        .WithMany("DirectoryNumbers")
                        .HasForeignKey("PhoneDirectoryDirectoryId");
                });
